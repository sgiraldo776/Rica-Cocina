...
CREATE TABLE IF NOT EXISTS `rica_cocina`.`tblroles` (
  `tiporolid` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `rica_cocina`.`tblcuenta` (
  ...
  `passwordanterior` VARCHAR(25) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `rica_cocina`.`tblngrediete`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rica_cocina`.`tblngrediete` (
  `ingredienteid` INT(11) NOT NULL AUTO_INCREMENT,
  `cantidad` VARCHAR(45) NOT NULL,
  `descripcion` VARCHAR(150) NOT NULL,
  `recetaid` INT(11) NOT NULL,
  PRIMARY KEY (`ingredienteid`),
  CONSTRAINT `fk_tblngrediete_tblreceta1`
...
-- -----------------------------------------------------
-- Table `rica_cocina`.`tblpasos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rica_cocina`.`tblpasos` (
  `pasosid` INT(11) NOT NULL AUTO_INCREMENT,
  `nropaso` INT(11) NOT NULL,
  `descripcion` VARCHAR(300) NOT NULL,
  `recetaid` INT(11) NOT NULL,
  PRIMARY KEY (`pasosid`),
  CONSTRAINT `fk_tblpasos_tblreceta1`
    FOREIGN KEY (`recetaid`)
    REFERENCES `rica_cocina`.`tblreceta` (`recetaid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
