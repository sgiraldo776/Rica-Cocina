...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-09-2020 a las 01:35:47
...
ALTER TABLE `tblusuario`
  ...
  ADD KEY `fk_tblusuario_tblmunicipio1` (`municipioid`);
...
ALTER TABLE `tblutensilios`
  ...
  ADD UNIQUE KEY `utensilioid_UNIQUE` (`utensilioid`);
...
--
ALTER TABLE `tblroles`
  MODIFY `tiporolid` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tblusuario`
  ADD CONSTRAINT `fk_tblusuario_tblmunicipio1` FOREIGN KEY (`municipioid`) REFERENCES `tblmunicipio` (`municipioid`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
