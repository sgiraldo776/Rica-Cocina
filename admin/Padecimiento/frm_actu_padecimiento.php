...
<head>
    ...
    <link rel="stylesheet" href="../admin/css/bootstrap.min.css" integrity="sha384-JcKb8q3iqJ61gNV9KGb8thSsNjpSL0n8PARn9HuZOnIxN0hoP+VmmDGMN5t9UJ0Z" crossorigin="anonymous"><!--Importacion css bootstrap-->
    <link rel="stylesheet" type="text/css" href="../css/style.css">
    <link rel="stylesheet" type="text/css" href="../css/styles1.css">
    <link href="https://fonts.googleapis.com/css2?family=Pacifico&family=Quicksand:wght@400;700&display=swap" rel="stylesheet"> 
    <link rel="icon" type="image/png" href="../../img/favicon.png">
    <title>Formulario Actualizar Padecimiento</title>
</head>
<body>
<header class="site-header" id="nav">
    ...
    <main class="col-12">
        <div class="container text-center mt-4">
            <div>
                <h1>Actualizar Padecimiento</h1>
            </div><!-- Div Nav-->
            <form action="actualizar_padecimiento.php" name="add_form" method="post">
                <input type="hidden" name="padecimientoid" value="<?php echo $id ?>">
                <input type="text" name="nombre" id="txt_padecimiento" placeholder="Nombre Padecimiento" value="<?php echo $fila['nombre'] ?>"><br>
                <input type="button" onclick="validarformulario()" value="Actualizar" class="boton boton-amarillo">
            </form>
        </div>
    </main>
    <!--JS de bootstrap-->
