    ...
    <div class="row">
        ...
        <main class="col-10">
            <div class="container text-center mt-4">
                <div>
                    <h1>Ingresar Padecimiento</h1>
                </div><!-- Div Nav-->
                <div>
                    <form action="insertar_padecimiento.php" name="add_form" method="post">
                        <label>Nombre:</label><br>
                        <input type="text" name="nombre" id="txt_padecimiento" placeholder="Nombre Padecimiento"><br><br>
                        <button type="button" onclick="validarformulario();" class="boton boton-amarillo">Guardar</button> 
                    </form>
                </div><!-- Div Form -->
                <div class="mt-4">
